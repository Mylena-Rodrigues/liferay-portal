...
package com.liferay.ai.hub.cell.web.internal.content.site.generator.display.context;
...
public class ViewContentSitesDisplayContext {
	...
	public List<DropdownItem> getBulkActionDropdownItems() throws Exception {
		return List.of(
			new FDSActionDropdownItem(
				StringBundler.concat(getAPIURL(), "/{id}"), "trash", "delete",
		...
		return CreationMenuBuilder.addDropdownItem(
			dropdownItem -> {
				...
				dropdownItem.setLabel(
					LanguageUtil.get(
						_httpServletRequest, "new-generator"));
			}
		).build();
	}
	...
	public List<FDSActionDropdownItem> getFDSActionDropdownItems()
		...
		return List.of(
			new FDSActionDropdownItem(
				StringBundler.concat(getAPIURL(), "/{id}"), "view", "view",

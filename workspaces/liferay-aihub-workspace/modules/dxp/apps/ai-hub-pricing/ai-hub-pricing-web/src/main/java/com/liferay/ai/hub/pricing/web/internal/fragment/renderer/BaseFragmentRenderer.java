...
import com.liferay.ai.hub.pricing.web.internal.constants.AIHubPricingWebConstants;
...
public abstract class BaseFragmentRenderer<T> implements FragmentRenderer {
	...
	@Reference(
		target = "(osgi.web.symbolicname=" + AIHubPricingWebConstants.BUNDLE_SYMBOLIC_NAME + ")"
	)

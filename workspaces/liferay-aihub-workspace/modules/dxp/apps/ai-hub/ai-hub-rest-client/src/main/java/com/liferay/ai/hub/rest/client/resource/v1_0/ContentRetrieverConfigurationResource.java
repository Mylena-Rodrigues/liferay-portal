 ...
 */
@Generated("")
public interface ContentRetrieverConfigurationResource {
	...
	public HttpInvoker.HttpResponse
			getContentRetrieverByExternalReferenceCodeContentRetrieverConfigurationsPageHttpResponse(
				String externalReferenceCode, String search,
				String filterString, Pagination pagination)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			putContentRetrieverByExternalReferenceCodeContentRetrieverConfigurationHttpResponse(
				String externalReferenceCode,
				String contentRetrieverConfigurationExternalReferenceCode,
				ContentRetrieverConfiguration contentRetrieverConfiguration)
		throws Exception;
	...
	public static class Builder {
		...
		public ContentRetrieverConfigurationResource build() {
			return new ContentRetrieverConfigurationResourceImpl(this);
		}
	...
	public static class ContentRetrieverConfigurationResourceImpl
		implements ContentRetrieverConfigurationResource {
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/ai-hub/v1.0/content-retrievers/by-external-reference-code/{externalReferenceCode}/content-retriever-configurations/{contentRetrieverConfigurationExternalReferenceCode}");
		...
		public Page<ContentRetrieverConfiguration>
			...
			try {
				return Page.of(
					content, ContentRetrieverConfigurationSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/ai-hub/v1.0/content-retrievers/by-external-reference-code/{externalReferenceCode}/content-retriever-configurations");
		...
		public ContentRetrieverConfiguration
			...
			try {
				return ContentRetrieverConfigurationSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.body(
				contentRetrieverConfiguration.toString(), "application/json");
		...
		private ContentRetrieverConfigurationResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			ContentRetrieverConfigurationResource.class.getName());
...
// LIFERAY-REST-BUILDER-HASH:733969252
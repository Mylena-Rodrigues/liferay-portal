 ...
 */
public class ViewTechnicalInsightDetailsDisplayContext {

	public ViewTechnicalInsightDetailsDisplayContext(
	...
	public List<Map<String, Object>> getBreadcrumbItems() throws Exception {
		return List.of(
			HashMapBuilder.<String, Object>put(
				...
				"label", _language.get(_httpServletRequest, "technical")
			).build());
	}
	...
	private String _getBackURL() throws Exception {
		...
		Layout layout = LayoutLocalServiceUtil.fetchLayoutByFriendlyURL(
			_themeDisplay.getScopeGroupId(), false, "/technical");

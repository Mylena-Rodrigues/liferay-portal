...
public abstract class BaseAgentInstanceResourceImpl
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/ai-hub/v1.0/agent-instances' -d $'{"agentDefinitionExternalReferenceCode": ___, "asynchronous": ___, "context": ___, "instructionDefinitionScope": ___, "sseEventSinkKey": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(name = "AgentInstance")
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'PUT' 'http://localhost:8080/o/ai-hub/v1.0/agent-instances/{agentInstanceId}/resume' -d $'{"agentDefinitionExternalReferenceCode": ___, "asynchronous": ___, "context": ___, "instructionDefinitionScope": ___, "sseEventSinkKey": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@jakarta.ws.rs.PUT
	@Override
	public void putAgentInstanceResume(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
...
// LIFERAY-REST-BUILDER-HASH:1989207773
 ...
 * <code>com.liferay.dc.service.impl.DocumentsLocalServiceImpl</code> and
...
public class DocumentsLocalServiceUtil {
	 ...
	 */
	public static Documents addDocuments(Documents documents) {
	 ...
	 */
	public static Documents createDocuments(long documentId) {
	...
	public static Documents deleteDocument(long documentId)
		throws PortalException {
	 ...
	 */
	public static Documents deleteDocuments(Documents documents) {
	 ...
	 */
	public static Documents deleteDocuments(long documentId)
		throws PortalException {
	...
	public static Documents fetchDocuments(long documentId) {
	 ...
	 * @throws PortalException if a documents with the primary key could not be found
	 */
	public static Documents getDocuments(long documentId)
		throws PortalException {
	 ...
	 */
	public static List<Documents> getDocumentses(int start, int end) {
	 ...
	 */
	public static Documents updateDocuments(Documents documents) {
	...
	private static volatile DocumentsLocalService _service;

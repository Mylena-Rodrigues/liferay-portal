...
} from '../../../../src/main/resources/META-INF/resources/js/AIAssistantChat/utils/formatContentGapAnalysis';
...
describe('formatContentGapAnalysis', () => {
	...
	it('exposes the Content Gap Analysis agent reference code', () => {
		expect(CONTENT_GAP_ANALYSIS_ERC).toBe('L_CONTENT_GAP_ANALYSIS');
	});
});

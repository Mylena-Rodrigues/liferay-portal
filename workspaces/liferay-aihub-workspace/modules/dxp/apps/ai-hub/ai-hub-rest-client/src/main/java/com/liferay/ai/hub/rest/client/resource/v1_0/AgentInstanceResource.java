...
public interface AgentInstanceResource {
	...
	public HttpInvoker.HttpResponse putAgentInstanceResumeHttpResponse(
			Long agentInstanceId, AgentInstance agentInstance)
		throws Exception;
	...
	public static class AgentInstanceResourceImpl
		...
		public void putAgentInstanceResume(
			...
			HttpInvoker.HttpResponse httpResponse =
				putAgentInstanceResumeHttpResponse(
		...
		public HttpInvoker.HttpResponse putAgentInstanceResumeHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/ai-hub/v1.0/agent-instances/{agentInstanceId}/resume");

			httpInvoker.path("agentInstanceId", agentInstanceId);
...
// LIFERAY-REST-BUILDER-HASH:-1055257200